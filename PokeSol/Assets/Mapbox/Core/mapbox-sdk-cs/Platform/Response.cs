...
namespace Mapbox.Platform
{
    ...
    public class Response
    {
        ...
        /// <summary>Flag to indicate if the request was fulfilled from a local cache</summary>
        ...
        /// <summary> Exceptions that might have occurred during the request. </summary>
        ...
        public static Response FromWebResponse(IAsyncRequest request, UnityWebRequest apiResponse, Exception apiEx)
        {
            ...
            // Updated check for network error
            // Previously: if (apiResponse.isNetworkError && !string.IsNullOrEmpty(apiResponse.error))
