...
namespace PkmngoBackendTesting
{
    ...
    public partial class PkmngoBackendTestingClient : TransactionalBaseClient<PkmngoBackendTestingErrorKind>
    {
        ...
        {
            return new Dictionary<uint, ProgramError<PkmngoBackendTestingErrorKind>>
            {
                { 6000U, new ProgramError<PkmngoBackendTestingErrorKind>(PkmngoBackendTestingErrorKind.NotEnoughEnergy, "Not enough energy") },
                { 6001U, new ProgramError<PkmngoBackendTestingErrorKind>(PkmngoBackendTestingErrorKind.WrongAuthority, "Wrong Authority") },
                { 6002U, new ProgramError<PkmngoBackendTestingErrorKind>(PkmngoBackendTestingErrorKind.ArithmeticError, "Arithmetic operation failed") },
                { 6003U, new ProgramError<PkmngoBackendTestingErrorKind>(PkmngoBackendTestingErrorKind.GymBossCannotCatchPokemon, "Gym boss cannot catch Pokémon") }
            };
        }
    }
    ...
    public static class PkmngoBackendTestingProgram
    {
        ...
        public static TransactionInstruction CatchPokemon(CatchPokemonAccounts accounts, string _level_seed, ushort counter, PublicKey programId = null)
        {
            programId ??= new(ID);
            List<AccountMeta> keys = new()
            {
                AccountMeta.ReadOnly(accounts.SessionToken == null ? programId : accounts.SessionToken, false),
                ...
                AccountMeta.Writable(accounts.GymBossAccount, false),
        ...
        public static TransactionInstruction ChallengeGym(ChallengeGymAccounts accounts, string _level_seed, ushort counter, PublicKey programId = null)
        {
            programId ??= new(ID);
            List<AccountMeta> keys = new()
            {
        ...
        public static TransactionInstruction ChopTree(ChopTreeAccounts accounts, string _level_seed, ushort counter, PublicKey programId = null)
        {
            programId ??= new(ID);
            List<AccountMeta> keys = new()
            {
        ...
        public static TransactionInstruction InitPlayer(InitPlayerAccounts accounts, string _level_seed, PublicKey programId = null)
        {
            programId ??= new(ID);
            List<AccountMeta> keys = new()
            {
        ...
        public static TransactionInstruction ResetGame(ResetGameAccounts accounts, string _level_seed, PublicKey programId = null)
        {
            programId ??= new(ID);
            List<AccountMeta> keys = new()
            {
        ...
        public static TransactionInstruction ResetPlayer(ResetPlayerAccounts accounts, string _level_seed, PublicKey programId = null)
        {
            programId ??= new(ID);
            List<AccountMeta> keys = new()
            {
