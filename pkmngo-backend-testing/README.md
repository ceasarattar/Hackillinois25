...
dotnet anchorgen -i target/idl/pkmngo_backend_testing.json -o target/idl/PkmngoBackendTesting.cs
```

(Replace pkmngo_backend_testing with the name of your program)
...
useEffect(() => {
    ...
    const [pda] = PublicKey.findProgramAddressSync(
        ...
        publicKey.toBuffer()],
        new PublicKey(PkmngoBackendTesting_PROGRAM_ID)
      );
    try {
