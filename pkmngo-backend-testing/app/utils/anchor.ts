...
import IDL from "../idl/pkmngo_backend_testing.json";
import { PkmngoBackendTesting } from "@/idl/pkmngo_backend_testing";
...
// PkmngoBackendTesting game program ID
export const PROGRAM_ID = new PublicKey(IDL.address);

export function getProgram(provider: AnchorProvider) {
  return new Program(IDL as PkmngoBackendTesting, provider);
}
...
export type PlayerData = IdlAccounts<PkmngoBackendTesting>["playerData"]
export type GameData = IdlAccounts<PkmngoBackendTesting>["gameData"]
